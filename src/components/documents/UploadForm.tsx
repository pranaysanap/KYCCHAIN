...
import { Upload, X, Copy, FileText, Image, AlertCircle, CheckCircle } from 'lucide-react';
...
const UploadForm: React.FC<UploadFormProps> = ({ onUploadSuccess }) => {
  ...
  return (
    <div className="glassmorphism rounded-xl p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                ...
                <p className="text-blue-400 text-sm capitalize">{documentType}</p>
              </div>
            </div>
          </div>
        )}
      ...
      {/* Error Message */}
      {error && (
        <div className="flex items-center space-x-2 text-red-400 text-sm mt-2 mb-4">
      ...
      {selectedFile && (
        <div className="mt-4 p-4 bg-gray-800/50 rounded-lg">
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-gray-300">SHA-256 Hash</label>
            {isComputingHash && (
